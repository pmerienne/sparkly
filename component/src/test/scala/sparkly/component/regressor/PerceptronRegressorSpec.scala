...
class PerceptronRegressorSpec extends ComponentSpec {

  "PerceptronRegressor" should "train on random data" in {
    // Given
    val configuration = ComponentConfiguration (
      name = "PerceptronRegressor",
      clazz = classOf[PerceptronRegressor].getName,
      inputs = Map(
    ...
    component.inputs("Train").push(400, DataGenerator.regressionData(10))
